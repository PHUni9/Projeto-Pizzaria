    ...
    <div class="container text-left">
        <div class="row justify-content-center">
            <div class="col-8">
                ...
                <%-- Aqui recupera o parâmetro de email da URL --%>
                <%
                    String email = request.getParameter("email");
                    email = (email != null) ? email : ""; // Caso não haja parâmetro, coloca uma string vazia
                %>

                <label for="email" class="form-label">E-mail</label>
                <input type="text" class="form-control mb-3" id="email" value="<%= email %>" placeholder="Digite seu e-mail" />

                <label for="senha" class="form-label">Senha</label>
                <input type="password" class="form-control mb-3" id="senha" placeholder="Digite sua senha" /> 

                <br>
                <button type="button" class="btn btn-primary" onclick="fazer_login()">Entrar</button>
                <br><br>
                
                <a href="PageCadastroFuncionario.jsp" class="btn btn-secondary">Novo Usuário</a>
            </div>
        </div>
    </div>
</main>
